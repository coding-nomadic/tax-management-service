...
* The original package name 'com.example.taxi-service' is invalid and this project uses 'com.example.taxiservice' instead.
...
* [Spring Data Reactive Redis](https://docs.spring.io/spring-boot/docs/2.7.9/reference/htmlsingle/#data.nosql.redis)
